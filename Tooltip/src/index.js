  ...
  render() {
    ...
    return (
      <div style={{display: 'inline'}}>
        <span style={{color: 'wheat'}} onMouseEnter={this.toggle} onMouseOut={this.toggle}>
          {this.props.children}
        </span>
...
ReactDOM.render(<div><Tooltip text="Created By Ehsan"><p id="para">Tooltip Example</p></Tooltip><br />
